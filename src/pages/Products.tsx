    ...
    <div className="pt-20 md:pt-24 pb-16 md:pb-32">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 max-w-6xl mx-auto">
          ...
          >
            <div className="aspect-[16/10] bg-gray-50 flex items-center justify-center p-6 md:p-8 relative overflow-hidden">
          ...
          <motion.div 
            ...
            className="rounded-3xl border border-gray-200 border-dashed bg-gray-50 flex flex-col items-center justify-center p-6 md:p-12 text-center"
          >
